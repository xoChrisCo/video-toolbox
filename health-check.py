...
Output:
    - Creates a CSV file in the specified output folder (or 'output_healthcheck' by default) with a timestamp, 
...
def check_videos(folder_path, num_samples, sample_duration, extensions, output_folder, quiet):
    ...
    # Create filename with sample and duration information
...
def main():
    ...
    parser.add_argument("-o", "--output", default="output_healthcheck", help="Custom output folder for the CSV file")
